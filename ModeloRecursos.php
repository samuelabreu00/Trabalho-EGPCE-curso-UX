                ...
                <div class="col-md-10">
                    ...
                    <div class="page-title Texto">
                        ...
                        <div class="bd-callout bd-callout-success">
                            ...
                            <footer class="text-end blockquote-footer">PEF</footer>
                        </div>
                        ...
                        <ul class="none">
                            ...
                            <li class="wow fadeInLeft" data-wow-delay="1.9s"><i class="fa fa-plus CorVerdeClaroEstado"></i> fa fa-plus-right-alt-circle-right.</li>
                            <li class="wow fadeInLeft" data-wow-delay="1.9s"><i class="fa fa-folder CorVerdeClaroEstado"></i> fa fa-plus-right-alt-circle-right.</li>
                            <li class="wow fadeInLeft" data-wow-delay="1.9s"><i class="fa fa-folder-open CorVerdeClaroEstado"></i> fa fa-plus-right-alt-circle-right.</li>
                            <li class="wow fadeInLeft" data-wow-delay="1.9s"><i class="fa fa-file CorVerdeClaroEstado"></i> fa fa-plus-right-alt-circle-right.</li>
                        </ul>
                        <!-- FIM Marcadores -->
                        <!--Alerta Azul  -->
                        <div class="headline alert alert-info" role="alert"><p headline><strong>Tais objetivos devem ser:</strong></p>
                            <ul class="none">
                                <li class="wow fadeInLeft" data-wow-delay="0.3s"><i class="fa fa-arrow-alt-circle-right "></i> Precisos – Determinados com exatidão;</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s"><i class="fa fa-arrow-alt-circle-right "></i> Quantificáveis – Possível de se determinar um valor em termos numéricos; que se pode calcular, medir, mensurar;</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s"><i class="fa fa-arrow-alt-circle-right "></i>  Realistas – Real, voltado a realidade em concreto, dentro das possibilidades;</li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s"><i class="fa fa-arrow-alt-circle-right "></i> Alcançáveis – No prazo estabelecido.</li>
                            </ul>
                        </div>
                        <br>
                        <!-- Tem que ter o script headline para a função funcionar -->
